...
import br.com.fiap.jdbc.models.AreaDeAtuacao;
...
public class AppController {
	...
	private AppController() throws SQLException {
		...
		this.areaDAO = new AreaDeAtuacao(connection);
	}
	...
	public void buscarTodosCandidatos() throws SQLException {
		...
		for (Candidato candidato : lista) {
			...
			System.out.println("Data Nascimento: " + candidato.getDatNasc());
	...
	public List<AreaDeAtuacao> listarAreaAtuacaoComCandidato() {
		return areaDAO.selectAreaDeAtuacaoCandidato();
	}
}
